...
| tplConfig | bool | `false` | Pass the Application configuration through Helm's templating engine. See the [helm documentation](https://helm.sh/docs/developing_charts/#using-the-tpl-function) |
